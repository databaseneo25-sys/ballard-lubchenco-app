...
DATA = {
    ...
    "P10": [550, 700, 850, 1000, 1150, 1300, 1450, 1600, 1750, 1900, 2100, 2300, 2500, 2700, 2850, 2950, 3050, 3100, 3150, 3200],
    "P25": [650, 850, 1000, 1150, 1350, 1500, 1650, 1850, 2000, 2200, 2450, 2650, 2850, 3050, 3200, 3300, 3400, 3450, 3500, 3550],
    "P50": [750, 950, 1100, 1300, 1500, 1700, 1900, 2100, 2300, 2550, 2800, 3000, 3200, 3400, 3550, 3650, 3750, 3800, 3850, 3900],
    "P75": [850, 1050, 1250, 1450, 1700, 1900, 2100, 2300, 2500, 2750, 3000, 3250, 3450, 3650, 3800, 3950, 4050, 4100, 4150, 4200],
    "P90": [950, 1150, 1350, 1550, 1800, 2000, 2200, 2400, 2650, 2900, 3150, 3400, 3600, 3800, 3950, 4100, 4200, 4300, 4400, 4500],
}
...
st.markdown("Persembahan oleh Ruang Transisi RSUD dr. Mohamad Soewandhie Surabaya Sebagai inovasi pelayanan dalam penilaian usia gestasi dan status pertumbuhan neonatus dengan Estimasi usia gestasi dari skor Ballard, klasifikasi berat lahir terhadap kurva Lubchenco, grafik multi-percentile, interpretasi klinis (WHO + IDAI style).")
